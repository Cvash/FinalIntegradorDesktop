 ...
 * @author Traorepes
 */
public class Frm_buscar_autor extends javax.swing.JFrame {

    /**
     * Creates new form Frm_buscar_autor
     */
    public Frm_buscar_autor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_buscar_autor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frm_buscar_autor().setVisible(true);
            }
        });
    }
